...
strategic acumen. My track record of developing cutting-edge software solutions,
conducting groundbreaking research, and effectively guiding cross-functional
teams showcase my ability to excel in diverse roles. With a passion for driving
...
(DNNs), with a particular focus on Pre-Trained Models (PTMs).

I got a B.Sc. in Computer Science from Loyola University Chicago (LUC) in 2022.
I'm currently working towards my M.S. in Computer Science from LUC and am
expected to graduate in the Spring of 2024. After my M.Sc., I intend to return once
more to LUC to get my Ph.D. in Computer Science.
...
Concerning my experience in academic research, I have published five
...
- 🕴️ [LinkedIn](https://www.linkedin.com/in/nsynovic/)
