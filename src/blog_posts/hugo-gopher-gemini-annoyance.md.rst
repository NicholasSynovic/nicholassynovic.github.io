...
creating front ends for websites, so I choose to use the Hugo [0] static
...
Luckily, Jason F. Betrayer had already figured this out in a blog post
...
``pernicious`` [8] server, the site was malformed. Links to blog pages
...
stubbornness was because I knew it was possible to do this conversion,
...
about Pub Nix: community ran servers that run on low powered machines.
...
few people could log into at a time. A subset of these Pub Nixs is the
``tildeverse`` [12]. These are **very** community oriented servers that
offer free web hosting of the Gemini, Gopher, HTTP, and Spartan sites.
...
content (maintenance, privacy, port forwarding, etc.) off of your
shoulders
