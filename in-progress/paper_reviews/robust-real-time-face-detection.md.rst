...
title: A summary of Robust Real Time-Face Detection by P. Viola and M.J.
Jones description: Published in the 2004 International Journal of
Computer Vision summary: Published in the 2004 International Journal of
Computer Vision

categories: [summary, face detection, boosting, human sensing,
International Journal of Computer Vision, 2004] citations:
...
==============================================
   ...
   `DOI <https://doi.org/10.1023/B:VISI.0000013087.49260.fb>`__
...
- `A summary of Robust Real-Time Face
  Detection <#a-summary-of-robust-real-time-face-detection>`__
...
The paper *Robust Real-Time Face Detection* by P. Viola and M.J. Jones
[1] presents a new methodology for efficiently performing face
...
further reduces computation time as each classifier specifies . Finally,
...
This is a research paper focusing on improving the Computer Vision task
of face detection without the reliance of CNNs.
...
building a cascade of classifiers which further reduces computation time
as each classifier specifies . Finally, they propose experiments that
can be ran on face detection data sets to conduct supervised learning.
...
Prior work has been done in creating face detection systems. Prior work
has been done in creating the Ada Boost algorithm that is used to create
a cascade of classifiers. Prior work has been done in identifying
methodologies to create image features.
...
reliably identifying faces in images. Additionally, the authors also
present a methodology for doing this task efficiently on low end
hardware.
...
Yes, however a bit lengthy. Optimizations could have been made with
respect to reducing the amount of content describing the background to
...
I'd like to implement their work on a low powered device and compare it
to a newer CNN model on ML metrics.
